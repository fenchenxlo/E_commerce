...
def api_search(request):
	...
	if query:
		...
		if "pro" in words and "max" in words:

			products = products.filter(
				Q(name__icontains="pro max")
				|
				Q(regex_name__icontains="pro max")
			)
